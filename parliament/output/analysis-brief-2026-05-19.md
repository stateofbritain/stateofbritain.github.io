...
**Sitting:** 2026-05-19 · House of Commons
**Transcript:** 24 sections · 549 contributions · 74,759 words

This is Step 2 of the Hansard Highlights pipeline. Your job is to select the
day's editorial highlights from the House of Commons sitting on 2026-05-19 — a
...
Read the full indexed transcript JSON:
    ...
    output/transcript-indexed-2026-05-19.json
...
Write the JSON object — and nothing else — to:
    ...
    output/highlights-raw-2026-05-19.json
