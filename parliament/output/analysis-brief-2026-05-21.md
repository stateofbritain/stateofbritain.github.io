...
**Sitting:** 2026-05-21 · House of Commons
**Transcript:** 23 sections · 663 contributions · 72,840 words

This is Step 2 of the Hansard Highlights pipeline. Your job is to select the
day's editorial highlights from the House of Commons sitting on 2026-05-21 — a
...
Read the full indexed transcript JSON:
    ...
    output/transcript-indexed-2026-05-21.json
...
Write the JSON object — and nothing else — to:
    ...
    output/highlights-raw-2026-05-21.json
