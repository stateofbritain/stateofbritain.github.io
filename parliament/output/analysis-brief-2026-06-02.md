...
**Sitting:** 2026-06-02 · House of Commons
**Transcript:** 22 sections · 1122 contributions · 83,544 words

This is Step 2 of the Hansard Highlights pipeline. Your job is to select the
day's editorial highlights from the House of Commons sitting on 2026-06-02 — a
...
Read the full indexed transcript JSON:
    ...
    output/transcript-indexed-2026-06-02.json
...
Write the JSON object — and nothing else — to:
    ...
    output/highlights-raw-2026-06-02.json
