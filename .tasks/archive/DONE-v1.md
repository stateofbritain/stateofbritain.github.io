...
- **Completed:** 2026-03-06
- **Points delivered:** 5
- **Key files changed:** `scripts/fetch-infrastructure.js`, `public/data/infrastructure.json`, `src/pillars/growth/Infrastructure.jsx`, `src/App.jsx`, `package.json`
- **Notes:** Fetch script downloads ORR Table 1220 (passenger journeys ODS, 1984-2025) and DfT TRA0101 (road traffic by vehicle type ODS, 2000-2024). Curated data: Ofcom Connected Nations (FTTP 2018-2025, gigabit 2019-2025, speeds 2018-2023, mobile 4G 2019-2025), ORR rail punctuality (PPM + On Time, 2013-2025), DfT road condition RDC0120 (2010-2024). Three sections: Broadband & Digital (coverage area chart / speeds line / mobile 4G bar toggle), Rail Network (journeys area chart / punctuality line with 92.5% target), Road Network (traffic stacked area by vehicle type / condition line by road class). Key data: FTTP 78% (23.7m premises), gigabit 87%, 1,729m rail journeys (99% pre-Covid), PPM 88.6%, 336.2bn vehicle miles, unclassified roads 19% poor. Completes all 7 Growth Engine pillar topics.
