 ...
 *
 * HMRC's Overseas Trade in Goods OData API exposes counterpart
 * countries via `CountryCodeAlpha` (alpha-2 like "DE", "FR", "GB").
 * The UNGA alignment dataset (Voeten / Bailey-Strezhnev) uses ISO3
 * alpha-3 codes ("DEU", "FRA", "GBR"). This table bridges the two.
 *
 * Source: ISO 3166-1 standard (en.wikipedia.org/wiki/ISO_3166-1).
 * 249 entries covering currently-assigned codes plus a handful of
 * exceptional reservations (e.g. Kosovo "XK").
 */
const ALPHA2_TO_ALPHA3 = {
  ...
  VU: "VUT",
  WF: "WLF", WS: "WSM",
  XK: "XKX", // Kosovo, exceptional reservation
  YE: "YEM", YT: "MYT",
...
export default ALPHA2_TO_ALPHA3;
