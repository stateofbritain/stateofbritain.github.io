 ...
 *  - MoD Annual Report & Accounts
 *  - NATO Defence Expenditure data
 *  - MoD UK Armed Forces Quarterly Service Personnel Statistics
 *  - SIPRI Military Expenditure Database
 *
 * Outputs: public/data/defence.json
 */
...
const output = {
  ...
  meta: {
    ...
    sources: [
      { name: "NATO Defence Expenditure", url: "https://www.nato.int/cps/en/natohq/topics_49198.htm" },
      { name: "MoD Annual Report & Accounts", url: "https://www.gov.uk/government/collections/mod-annual-report-and-accounts" },
      { name: "MoD Armed Forces Personnel Statistics", url: "https://www.gov.uk/government/collections/uk-armed-forces-quarterly-manning-report" },
      { name: "MoD Equipment Plan", url: "https://www.gov.uk/government/collections/equipment-plan" },
      { name: "SIPRI Military Expenditure", url: "https://www.sipri.org/databases/milex" },
    ],
  },
};

writeFileSync("public/data/defence.json", JSON.stringify(output, null, 2));
console.log("  defence.json written (" + spendingPctGdp.length + " spending years, " + personnel.length + " personnel years)");
